...
# Environment variables are strings: bool("False") is True in Python. Parse
# this explicitly so CLONE_MODE=False does not start every clone during boot.
CLONE_MODE = environ.get('CLONE_MODE', '').strip().lower() in {'1', 'true', 'yes', 'on'}
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://web-production-5e43e.up.railway.app")
